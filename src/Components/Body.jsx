...
const Body = () => {
  return (
    ...
    <div className='flex items-center  justify-center lg:flex-1 lg:order-2 lg:justify-end lg:overflow-hidden'>
      <img src="./assets/Blue-Shape.png" alt="img1" className='h-64 -rotate-[45deg] md:h-72 lg:h-[450px] lg:overflow-hidden'/>
      <img src="./assets/Pink-Shape.png" alt="img2" className='absolute h-64 -rotate-[30deg]  md:h-72 lg:h-[450px] lg:overflow-hidden'/>
      <img src="./assets/Purple-Shape.png" alt="img3" className='absolute h-64 -rotate-[15deg]  md:h-72 lg:h-[450px] lg:overflow-hidden'/>
    ...
    <div className='space-y-4 lg:flex-1 lg:order-1 lg:space-y-10'>
      <h1 className='text-5xl font-bold leading-tight font-playfair '>Welcome to unofficial site of SKNSITS SE Department of IT</h1>
